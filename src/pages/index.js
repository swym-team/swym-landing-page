          ...
          <div className={"row"}>
            ...
            <div className={"col-6"}>
              <div className={"feature__content"}>
                ...
                <p>
                  Save your time and energy by letting SWYM to manage your
            ...
            <div className={"col-6"}>
              <div className={"feature__content"}>
                ...
                <p>
                  ...
                  news in an internal and attractive format via SWYM instead.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={"row"}>
            <div className={"col-6"}>
              <div className={"feature__content"}>
                <h2>Teams</h2>
                <p>
                  SWYM let you add staff in specific teams and manage them
                  easily.
                </p>
              </div>
            </div>
    ...
    <div className={"call-to-action"}>
      <div className={"container"}>
        ...
        <div className={"button"}>
          <a href="https://app.SWYM.io" target={"_blank"}>
            Get Started
          </a>
        </div>
      </div>
